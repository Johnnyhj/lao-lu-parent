...
public class Page implements java.io.Serializable {
	...
	public void setPagedView(String path) {
		...
		sb.append("&nbsp;");
		sb
				.append("<INPUT onclick='submit_pagedForm()' type=button class='button2' value=' GO '>");
		sb.append("&nbsp;&nbsp;&nbsp;&nbsp;");
		...
		sb
				.append("if (parseInt(page) > parseInt(totalPages) || parseInt(page) <1) {page =1;}\n");
	...
	public void setPagedView() {
		...
		StringBuffer sb = new StringBuffer();
		sb
				.append("<TABLE width='100%' class='content9' cellpadding='0' cellspacing='0'>");
		sb.append("<TBODY>");
		sb.append("<TR>");
		...
		if (hasPreviousPage) {
			...
			sb
					.append("<input type='button' value='首页' class='button' onclick='search_pagedForm(1);return false;'>");
			sb.append("&nbsp;&nbsp;");
			sb
					.append("<input type='button' value='上一页' class='button' onclick='search_pagedForm("
			...
			sb
					.append("<input type='button' value='首页' class='button' onclick='search_pagedForm(1);return false;' disabled='disabled'>");
			sb.append("&nbsp;&nbsp;");
			sb
					.append("<input type='button' value='上一页' class='button' onclick='search_pagedForm("
							+ (currentPage - 1)
		...
		if (hasNextPage) {
			sb
					.append("<input type='button' value='下一页' class='button' onclick='search_pagedForm("
							+ (currentPage + 1) + ");return false;'>");
			// sb.append("<a href='#' onclick='search_pagedForm("
			// + (currentPage + 1)
			// +
			...
			sb.append("&nbsp;&nbsp;");
			sb
					.append("<input type='button' value='末页' class='button' onclick='search_pagedForm("
		...
		sb.append("totalPages = document.forms[0].totalPages.value;\n");
		sb
				.append("if (parseInt(page) > parseInt(totalPages) ) {document.pagedForm.page.value =totalPages;}\n");
		sb
				.append("if(parseInt(page) <1) {document.pagedForm.page.value =1;}\n");
		sb.append("document.forms[0].submit();\n");
		sb.append("}\n");
		sb.append("function search_pagedForm(page) {\n");
		sb.append("document.pagedForm.page.value = page;\n");
