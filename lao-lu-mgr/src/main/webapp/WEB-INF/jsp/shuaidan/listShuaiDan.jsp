                    ...
                    <div class="col-lg-12">
                        <div class="panel wrapper panel-default">
                            <div class="panel-body">
                                <form id="frm" class="bs-example form-horizontal" action="${ctx}/core/shuaiDan" method="post">
                                ...
                                <table class="table table-striped b-t b-light text-base">
                                    ...
                                    <c:forEach items="${body.list}" var="object" varStatus="s">
                                        <tr>
                                            ...
                                            <td class="wd-md-2 text-C" ${w10}>
                                                <a class="updateClass" href="#" data-id="${object.orderId}" role="button">甩单</a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
    ...
    $(document).ready(function () {
        ...
        $(".updateClass").click(function () {
            ...
            if (confirm("确定甩单吗?")) {
                ...
                $.get(
                    '${ctx}/core/updateOrderStatus?orderId={object_id}&status={object_status}'.render(
                        {'object_id':$(this).attr("data-id"), "object_status":2}),
                    {},
                    function (data) {
                        alert(data.msg);

                        if (data.code == 0) {
                            window.location.href = '${ctx}/core/shuaiDan';
                        }
