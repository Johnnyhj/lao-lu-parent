                    ...
                    <div class="col-lg-12">
                        <div class="panel wrapper panel-default">
                            <div class="panel-body">
                                <form id="frm" class="bs-example form-horizontal" action="${ctx}/sysdata" method="post">
                                    ...
                                    <shiro:hasPermission name="user:view">
                                        ...
                                        <div class="col-xs-4">
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-8 no-padding-left no-padding-right">
                                                        <%--<input type="text" class="form-control col-xs-10" name="userType" id="userType" value="${param['userType']}" />--%>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <shiro:hasPermission name="sysdata:update">
                                                        <a href="${ctx}/sysdata/${data.ddId}/update"> 修改 </a>
                                                    </shiro:hasPermission>
                                                  <%--  <shiro:hasPermission name="sysdata:delete">
                                                        <a href="${ctx}/sysdata/${data.ddId}/delete"> 删除 </a>
                                                    </shiro:hasPermission>--%>
                                                </td>
                                ...
                                <div class="row">
                                    ...
                                    <span class="input-group-btn">
                                        ...
                                        <span class="pull-right"
                                              style="padding: 26px 14px;font-size: 16px;">总共 ${page.totalRows} 条</span>
                                    </div>
                                </div>
                            </footer>
                        </div>
