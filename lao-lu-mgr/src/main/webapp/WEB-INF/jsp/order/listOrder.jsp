                    ...
                    <div class="col-lg-12">
                        <div class="panel wrapper panel-default">
                            <div class="panel-body">
                                <form id="frm" class="bs-example form-horizontal" action="${ctx}/core/orders" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="order_content">
                                                <select id="status" name="status" class="form-control">
                                                    ...
                                                    <option value="0"
                                                            <c:if test="${0 eq param['status']}">selected</c:if> >待支付</option>
                                                    <option value="1"
                                                            <c:if test="${1 eq param['status']}">selected</c:if> >甩单中</option>
                                                    <option value="2"
                                                            <c:if test="${2 eq param['status']}">selected</c:if> >待竣工</option>
                                                    <option value="3"
                                                            <c:if test="${3 eq param['status']}">selected</c:if> >待发货</option>
                                                    <option value="4"
                                                            <c:if test="${4 eq param['status']}">selected</c:if> >已发货</option>
                                                    <option value="5"
                                                            <c:if test="${5 eq param['status']}">selected</c:if> >确认收货</option>
                                                    <option value="6"
                                                            <c:if test="${6 eq param['status']}">selected</c:if> >订单超时</option>
                                                    <option value="7"
                                                            <c:if test="${7 eq param['status']}">selected</c:if> >未竣工</option>
                                                    <option value="8"
                                                            <c:if test="${8 eq param['status']}">selected</c:if> >已退款</option>
                                                    <option value="9"
                                                            <c:if test="${9 eq param['status']}">selected</c:if> >支付失败</option>
                                                    <option value="10"
                                ...
                                <table class="table table-striped b-t b-light text-base">
                                    ...
                                    <c:forEach items="${body.list}" var="object" varStatus="s">
                                        <tr>
                                            ...
                                            <td class="wd-md-2 text-C" ${w10}>
                                                <a href="${ctx}/core/orderDetail?orderId=${object.orderId}" role="button">查看详情</a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
