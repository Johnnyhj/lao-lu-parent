 ...
 */
@Service
@AbilityRegister(name = "toAddDeliveryPageMain")
public class ToAddDeliveryPageMain extends ServiceParamMain implements IAbility
{
    private Logger logger = LoggerFactory.getLogger(ToAddDeliveryPageMain.class);
