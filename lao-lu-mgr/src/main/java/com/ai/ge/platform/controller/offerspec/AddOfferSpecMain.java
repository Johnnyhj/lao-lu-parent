 ...
 */
@Service
@AbilityRegister(name = "addOfferSpec")
public class AddOfferSpecMain extends ServiceParamMain implements IAbility
{
    private Logger logger = LoggerFactory.getLogger(AddOfferSpecMain.class);
    ...
    public Message execute(Message message)
    {
        ...
        try
        {
            ...
            offerSpecService.insertOfferSepc(record);
