 ...
 */
@Service
@AbilityRegister(name = "updateorder")
public class UpdateOrderMain implements IAbility
{
    private Logger logger = LoggerFactory.getLogger(UpdateOrderMain.class);
...
//            cache.setUserId("20881048382687909220349571918351");
            ...
            NumberInfo numberInfo = numberlist.get(0);
            //以套餐配置的省市为标准
            ...
            List<Freight> freightList = freightMapper.selectByExample(freightExample);
            ...
            int count = orderService.updateOrdersFromClient(orders);
            if(count>0){
