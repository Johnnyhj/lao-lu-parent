package com.ai.ge.dispatcher;

import com.ai.ge.ali.exception.AliException;
import com.ai.ge.ali.executor.*;
import com.ai.ge.constant.AlipayServiceEventConstants;
import com.ai.ge.constant.AlipayServiceNameConstants;
...
public class Dispatcher {
     ...
     * @throws AliException
     */
    public static ActionExecutor getExecutor(Map<String, String> params) throws AliException {
        //获取服务信息
        String service = params.get("service");
        if (StringUtils.isEmpty(service)) {
            throw new AliException("无法取得服务名");
        }
        //获取内容信息
        String bizContent = params.get("biz_content");
        if (StringUtils.isEmpty(bizContent)) {
            throw new AliException("无法取得业务内容信息");
        }
        ...
        if (StringUtils.isEmpty(msgType)) {
            throw new AliException("无法取得消息类型");
        }
    ...
    private static ActionExecutor getEventExecutor(String service, JSONObject bizContentJson)
        ...
        if (StringUtils.isEmpty(eventType)) {
            throw new AliException("无法取得事件类型");
        }
