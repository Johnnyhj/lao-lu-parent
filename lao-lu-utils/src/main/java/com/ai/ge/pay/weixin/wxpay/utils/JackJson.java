...
public class JackJson
{
    ...
    {
        return fromJsonToObject(json, valueType, null);
    }
     ...
     * @return
     */
    public static <T> T fromJsonToObject(String json, Class<T> collectionClass, Class... elementClasses)
    {
        ObjectMapper mapper = new ObjectMapper();
        ...
        try
        {
            if(elementClasses == null || elementClasses.length == 0){
                return mapper.readValue(json, collectionClass);
            }else{
     ...
     * @return
     */
    public static <T> T fromJsonToObject(String json, JavaType javaType)
    {
        ObjectMapper mapper = new ObjectMapper();
        mapper.setDateFormat(new SimpleDateFormat(DATE_TIME_FORMAT));
        mapper.getDeserializationConfig().set(
     ...
     * @return 返回对象
     */
    public static <T> T fromJsonToObjectWithDate(String json, Class<T> valueType, String dateTimeFormat)
    {
        ObjectMapper mapper = new ObjectMapper();
    ...
    {
        ObjectMapper mapper = new ObjectMapper();
        mapper.setDateFormat(new SimpleDateFormat(dateTimeFormatString));
        try
        {
            return mapper.writeValueAsString(object);
        }
