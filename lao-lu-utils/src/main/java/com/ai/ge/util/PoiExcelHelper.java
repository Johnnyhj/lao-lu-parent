...
public abstract class PoiExcelHelper {
     ...
     * 获取sheet列表，子类必须实现
     */
    public abstract ArrayList<String> getSheetList(InputStream inputStream) throws IOException;

    /**
     * 读取Excel文件数据
     */
    public ArrayList<ArrayList<String>> readExcel(InputStream inputStream, int sheetIndex) throws IOException {
     ...
     * 读取Excel文件数据
     */
    public ArrayList<ArrayList<String>> readExcel(InputStream inputStream, int sheetIndex, String rows) throws
            IOException {
     ...
     * 读取Excel文件数据
     */
    public ArrayList<ArrayList<String>> readExcel(InputStream inputStream, int sheetIndex, String[] columns) throws
            IOException {
     ...
     * 读取Excel文件数据，子类必须实现
     */
    public abstract ArrayList<ArrayList<String>> readExcel(InputStream inputStream, int sheetIndex, String rows,
